...
pub fn extract_text_around_line_asymmetric(content: &str, target_line: usize, context_before: usize, context_after: usize) -> String {
...
pub fn extract_xml_around_line_asymmetric(xml_content: &str, target_line: usize, context_before: usize, context_after: usize) -> String {
    use crate::extract_text;
    
    // まず指定行数の周辺を取得
    let raw_context = extract_text_around_line_asymmetric(xml_content, target_line, context_before, context_after);
...
pub fn extract_xml_around_line(xml_content: &str, target_line: usize, context_lines: usize) -> String {
